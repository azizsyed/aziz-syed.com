...
const Hero = () => (
  <Grid id="hero">
    <Row>
      <Col xs={12}><HeroSVG /></Col>
    </Row>
    <Row between="xs">
      <Col xs><Link href="#"><Icon className="ion-social-github-outline" /></Link></Col>
      <Col xs><Link href="#"><Icon className="ion-social-linkedin-outline" /></Link></Col>
      <Col xs><Link href="#"><Icon className="ion-social-facebook-outline" /></Link></Col>
      <Col xs><Link href="#"><Icon className="ion-social-codepen-outline" /></Link></Col>
      <Col xs><Link href="#"><Icon className="ion-ios-email-outline" /></Link></Col>
    </Row>
  </Grid>
);
